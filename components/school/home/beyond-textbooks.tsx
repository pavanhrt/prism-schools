...
const experiences = [
  ...
  { title: "Robotics & Makers", description: "Students turn ideas into working creations by designing, building and experimenting with robotics and technology.", Icon: Bot, visual: "mechanical" },
  { title: "Creative Thinking", description: "We encourage students to question, imagine, experiment and create solutions instead of simply memorizing answers.", Icon: Lightbulb, visual: "creative" },
